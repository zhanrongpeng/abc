...
/*=== wire-aware mapping API =====================================================*/
extern void            Map_ManSetWireAwareFromFrame( Map_Man_t * p );
extern float           Map_NodeReadLValue( Map_Node_t * pNode );
extern void            Map_NodeSetLValue( Map_Node_t * pNode, float LValue );
extern float           Map_NodeReadCoordX( Map_Man_t * p, int AigId );
extern float           Map_NodeReadCoordY( Map_Man_t * p, int AigId );
extern void            Map_ManSetNodeName( Map_Man_t * p, int AigId, void * pBlifNode );
extern void            Map_NodeSetOrigNode( Map_Node_t * pNode, void * pOrigNode );
extern void *          Map_NodeReadOrigNode( Map_Node_t * pNode );
extern const char *    Map_NodeReadDrivingPoName( Map_Man_t * p, Map_Node_t * pNode );
